...
public class FrameBase extends JFrame {
	...
	public static JPanel createPanel(JPanel panel, JComponent... compAry) {
		for (var comp : compAry) {
			panel.add(comp);
		}
	...
	public <T extends JComponent> T createComponent(T obj, Consumer<T> cons) {
		cons.accept(obj);
